...
<li><a href="/wenbanhang/Product/" class="text-dark">Danh sách sản

phẩm</a></li>

<li><a href="/wenbanhang/Product/add" class="text-dark">Thêm sản

phẩm</a></li>
</ul>
</div>
<!-- Cột mạng xã hội -->
<div class="col-lg-3 col-md-6 mb-4"></div><h5 class="text-uppercase">Kết nối với chúng tôi</h5>
